    ...
    constructor() {
      ...
      close = (event) =>  {
          this.setState({
            ...
            let newName = document.getElementById('dungeonTypeSpace')
            newName.textContent = "Dungeon Type: " + type
      }
...
render() {  
    ...
    return (
        <div>
        <div className="btns">
        <Button id="questGiver" variant="outline-success" size="lg" onClick={this.handleClick}>Type
        </Button>
            </div>
