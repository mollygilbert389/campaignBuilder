...
const Treasure = ({ campaign, onSetTreasureData }) => {
  ...
  const close = () => {
    ...
    setReduxTreasureData("treasureData", {
      ...campaign.treasureData,
      treasureTypes: treasueHolder,
  ...
  return (
    <div>
      ...
      <Modal show={showModal} onHide={() => setShowModal(!showModal)}>
        ...
        <Modal.Body>
          <p>
            Below are some buttons to help create the tresure and experience
            earned for your game!
          </p>
          <p>
            You have selected {campaign.rooms} rooms and a short campaign. Due
            to this reason we suggest you have {suggestedTreasure} treasures
            excluding the quest price. Please check the boxes below of items
            you'd like to include and we'll generate them for you.
          </p>
          <br />
          <Slider
            min={0}
          ...
          <FormGroup>
            ...
            <FormControlLabel
              ...
              label="Money"/>
            <FormControlLabel
              disabled={tradeGoods || gems || magicItem || equipment || money ? true : false}
              control={
                <Checkbox
                  checked={justXp}
