...
class PartySevenForm extends Component {
    constructor() {
        super();
        this.state ={
            playerOneName: "",
    ...
    playerhandleChange = (event) => {
      ...
      partyClick = () => {
        ...
        let playerSixPartyName = this.state.playerSixName
        let playerSixPartyClass = this.state.playerSixClass
        let playerSevenPartyName = this.state.playerSevenName
        let playerSevenPartyClass = this.state.playerSevenClass
        let playerEightPartyName = this.state.playerEightName
        let playerEightPartyClass = this.state.playerEightClass
        ...
        playerArray.push("Party Member #6: " + playerSixPartyName + " Class: " + playerSixPartyClass)
        playerArray.push("Party Member #7: " + playerSevenPartyName + " Class: " + playerSevenPartyClass)
        playerArray.push("Party Member #8: " + playerEightPartyName + " Class: " + playerEightPartyClass)
    ...
    playerOneSelectClass = (choice) => {
        if (this.state.playerOneClass = "") {
            let classSpace = document.getElementById('formEightOne')
    ...
    playerTwoSelectClass = (choice) => {
        if (this.state.playerTwoClass = "") {
            let classSpace = document.getElementById('formEightTwo')
            classSpace.innerText = "What class is this party member?"
        } else {
            let classSpace = document.getElementById('formEightTwo')
            classSpace.innerText = choice.target.text
    ...
    playerThreeSelectClass = (choice) => {
        if (this.state.playerThreeClass = "") {
            let classSpace = document.getElementById('formEightThree')
            classSpace.innerText = "What class is this party member?"
        } else {
            let classSpace = document.getElementById('formEightThree')
            classSpace.innerText = choice.target.text
    ...
    playerFourSelectClass = (choice) => {
        if (this.state.playerFourClass = "") {
            let classSpace = document.getElementById('formEightFour')
            classSpace.innerText = "What class is this party member?"
        } else {
            let classSpace = document.getElementById('formEightFour')
            classSpace.innerText = choice.target.text
    ...
    playerFiveSelectClass = (choice) => {
        if (this.state.playerFiveClass = "") {
            let classSpace = document.getElementById('formEightFive')
            classSpace.innerText = "What class is this party member?"
        } else {
            let classSpace = document.getElementById('formEightFive')
            classSpace.innerText = choice.target.text
   ...
   /////////////////////
    playerSixSelectClass = (choice) => {
        if (this.state.playerSixClass = "") {
            let classSpace = document.getElementById('formEightSix')
            classSpace.innerText = "What class is this party member?"
        } else {
            let classSpace = document.getElementById('formEightSix')
            classSpace.innerText = choice.target.text
        ...
        let newChoice = choice.target.text
        this.setState({
            playerSixClass: newChoice
        }, () => console.log(this.state.playerSixClass)
        )
    }

    /////////////////////
    playerSevenSelectClass = (choice) => {
        if (this.state.playerSevenClass = "") {
            let classSpace = document.getElementById('formEightSeven')
            classSpace.innerText = "What class is this party member?"
        } else {
            let classSpace = document.getElementById('formEightSeven')
            classSpace.innerText = choice.target.text
        ...
        let newChoice = choice.target.text
        this.setState({
            playerSevenClass: newChoice
        }, () => console.log(this.state.playerSevenClass)
        )
    }

    /////////////////////
    playerEightSelectClass = (choice) => {
        if (this.state.playerEightClass = "") {
            let classSpace = document.getElementById('formEightEight')
            classSpace.innerText = "What class is this party member?"
        } else {
            let classSpace = document.getElementById('formEightEight')
            classSpace.innerText = choice.target.text
        ...
        let newChoice = choice.target.text
        this.setState({
            playerEightClass: newChoice
        }, () => console.log(this.state.playerEightClass)
        )
    }
            ...
            <div className="forms">
                <div className="partyFormSpace">
                    <Form inline>
                        ...
                        <FormGroup className="mb-2 mr-sm-2 mb-sm-0">
                        <Dropdown>
                            <Dropdown.Toggle variant="outline-primary" id="formEightOne">
                ...
                <div className="partyFormSpace">
                    <Form inline>
                        ...
                        <FormGroup className="mb-2 mr-sm-2 mb-sm-0">
                        <Dropdown>
                            <Dropdown.Toggle variant="outline-primary" id="formEightTwo">
                            What is the class of this member?
                            </Dropdown.Toggle>
                            <Dropdown.Menu>
                ...
                <div className="partyFormSpace">
                    <Form inline>
                        ...
                        <FormGroup className="mb-2 mr-sm-2 mb-sm-0">
                        <Dropdown>
                            <Dropdown.Toggle variant="outline-primary" id="formEightThree">
                            What is the class of this member?
                            </Dropdown.Toggle>
                            <Dropdown.Menu>
                ...
                <div className="partyFormSpace">
                    <Form inline>
                        ...
                        <FormGroup className="mb-2 mr-sm-2 mb-sm-0">
                        <Dropdown>
                            <Dropdown.Toggle variant="outline-primary" id="formEightFour">
                            What is the class of this member?
                            </Dropdown.Toggle>
                            <Dropdown.Menu>
                    ...
                    <Form inline>
                        ...
                        <FormGroup className="mb-2 mr-sm-2 mb-sm-0">
                        <Dropdown>
                            <Dropdown.Toggle variant="outline-primary" id="formEightFive">
                            What is the class of this member?
                            </Dropdown.Toggle>
                            <Dropdown.Menu>
                    ...
                    <Form inline>
                        <FormGroup className="mb-2 mr-sm-2 mb-sm-0">
                            <Label className="mr-sm-2">Party Member #6</Label>
                            <Input type="names" name="playerSixName" placeholder="Name" value={this.state.playerSixName} onChange={this.playerhandleChange}/>
                        </FormGroup>
                        <FormGroup className="mb-2 mr-sm-2 mb-sm-0">
                        <Dropdown>
                            <Dropdown.Toggle variant="outline-primary" id="formEightSix">
                            What is the class of this member?
                            </Dropdown.Toggle>
                            <Dropdown.Menu>
                            <Dropdown.Item onClick={this.playerSixSelectClass}>Barbarian</Dropdown.Item>
                            <Dropdown.Item onClick={this.playerSixSelectClass}>Bard</Dropdown.Item>
                            <Dropdown.Item onClick={this.playerSixSelectClass}>Cleric</Dropdown.Item>
                            <Dropdown.Item onClick={this.playerSixSelectClass}>Druid</Dropdown.Item>
                            <Dropdown.Item onClick={this.playerSixSelectClass}>Fighter</Dropdown.Item>
                            <Dropdown.Item onClick={this.playerSixSelectClass}>Monk</Dropdown.Item>
                            <Dropdown.Item onClick={this.playerSixSelectClass}>Paladin</Dropdown.Item>
                            <Dropdown.Item onClick={this.playerSixSelectClass}>Ranger</Dropdown.Item>
                            <Dropdown.Item onClick={this.playerSixSelectClass}>Rogue</Dropdown.Item>
                            <Dropdown.Item onClick={this.playerSixSelectClass}>Sourcerer</Dropdown.Item>
                            <Dropdown.Item onClick={this.playerSixSelectClass}>Warlock</Dropdown.Item>
                            <Dropdown.Item onClick={this.playerSixSelectClass}>Wizard</Dropdown.Item>
                            </Dropdown.Menu>
                        </Dropdown>
                        </FormGroup>
                    </Form>
                    ...
                    <Form inline>
                        <FormGroup className="mb-2 mr-sm-2 mb-sm-0">
                            <Label className="mr-sm-2">Party Member #7</Label>
                            <Input type="names" name="playerSevenName" placeholder="Name" value={this.state.playerSevenName} onChange={this.playerhandleChange}/>
                        </FormGroup>
                        <FormGroup className="mb-2 mr-sm-2 mb-sm-0">
                        <Dropdown>
                            <Dropdown.Toggle variant="outline-primary" id="formEightSeven">
                            What is the class of this member?
                            </Dropdown.Toggle>
                            <Dropdown.Menu>
                            <Dropdown.Item onClick={this.playerSevenSelectClass}>Barbarian</Dropdown.Item>
                            <Dropdown.Item onClick={this.playerSevenSelectClass}>Bard</Dropdown.Item>
                            <Dropdown.Item onClick={this.playerSevenSelectClass}>Cleric</Dropdown.Item>
                            <Dropdown.Item onClick={this.playerSevenSelectClass}>Druid</Dropdown.Item>
                            <Dropdown.Item onClick={this.playerSevenSelectClass}>Fighter</Dropdown.Item>
                            <Dropdown.Item onClick={this.playerSevenSelectClass}>Monk</Dropdown.Item>
                            <Dropdown.Item onClick={this.playerSevenSelectClass}>Paladin</Dropdown.Item>
                            <Dropdown.Item onClick={this.playerSevenSelectClass}>Ranger</Dropdown.Item>
                            <Dropdown.Item onClick={this.playerSevenSelectClass}>Rogue</Dropdown.Item>
                            <Dropdown.Item onClick={this.playerSevenSelectClass}>Sourcerer</Dropdown.Item>
                            <Dropdown.Item onClick={this.playerSevenSelectClass}>Warlock</Dropdown.Item>
                            <Dropdown.Item onClick={this.playerSevenSelectClass}>Wizard</Dropdown.Item>
                            </Dropdown.Menu>
                        </Dropdown>
                        </FormGroup>
                    </Form>
                    ...
                    <Form inline>
                        <FormGroup className="mb-2 mr-sm-2 mb-sm-0">
                            <Label className="mr-sm-2">Party Member #8</Label>
                            <Input type="names" name="playerEightName" placeholder="Name" value={this.state.playerEightName} onChange={this.playerhandleChange}/>
                        </FormGroup>
                        <FormGroup className="mb-2 mr-sm-2 mb-sm-0">
                        <Dropdown>
                            <Dropdown.Toggle variant="outline-primary" id="formEightEight">
                            What is the class of this member?
                            </Dropdown.Toggle>
                            <Dropdown.Menu>
                            <Dropdown.Item onClick={this.playerEightSelectClass}>Barbarian</Dropdown.Item>
                            <Dropdown.Item onClick={this.playerEightSelectClass}>Bard</Dropdown.Item>
                            <Dropdown.Item onClick={this.playerEightSelectClass}>Cleric</Dropdown.Item>
                            <Dropdown.Item onClick={this.playerEightSelectClass}>Druid</Dropdown.Item>
                            <Dropdown.Item onClick={this.playerEightSelectClass}>Fighter</Dropdown.Item>
                            <Dropdown.Item onClick={this.playerEightSelectClass}>Monk</Dropdown.Item>
                            <Dropdown.Item onClick={this.playerEightSelectClass}>Paladin</Dropdown.Item>
                            <Dropdown.Item onClick={this.playerEightSelectClass}>Ranger</Dropdown.Item>
                            <Dropdown.Item onClick={this.playerEightSelectClass}>Rogue</Dropdown.Item>
                            <Dropdown.Item onClick={this.playerEightSelectClass}>Sourcerer</Dropdown.Item>
                            <Dropdown.Item onClick={this.playerEightSelectClass}>Warlock</Dropdown.Item>
                            <Dropdown.Item onClick={this.playerEightSelectClass}>Wizard</Dropdown.Item>
                            </Dropdown.Menu>
                        </Dropdown>
                        </FormGroup>
                    </Form>
